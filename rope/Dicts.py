PARAM_BUTTONS_PARAMS =    {
    ...
    'OccluderMessage':          'OCCLUDER - Automatic occluder. Any object in the face region is occluded. [LB: on/off, MW: increase/decrease occluder mask opacity]',
    ...
    'FaceParserMessage':        'PARSER - Performs occlusion based on features. [LB: on/off, RB: mouth & lower lip/everything but the face, MW: amount (0 is off, -1 and lower is whole mouth, only for mouth mode)]',
...
ACTIONS =   {
    ...
    'DockMessage':              'UNDOCK WINDOW - Undocks the window area. Cannot be re-docked.', 
    'DockButton':               [],
    'DockIconHolder':           [],
