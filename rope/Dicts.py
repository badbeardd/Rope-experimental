PARAM_BUTTONS_PARAMS =    {
    ...
    'MaskState':                False,
    'MaskMode':                 0, 
    'MaskModes':                ['Mask Top', 'Mask Sides', 'Mask Bottom'],  
    'MaskAmount':               [10, 10, 5],
    'MaskMin':                  0,
    'MaskMax':                  64,
    'MaskInc':                  1,                                                 
    ...
    'MaskMessage':              'MASK - Initial mask. A rectangle with adjustable top and sides that blends the Swapped Face into the original background. [RB: top/sides, MW: amount]',   
    
    'MaskBlurState':            False,
    'MaskBlurMode':             0, 
    'MaskBlurModes':            ['Mask Blur'],  
    'MaskBlurAmount':           [5],
    'MaskBlurMin':              0,
    'MaskBlurMax':              50,
    'MaskBlurInc':              1,                                                 
    'MaskBlurUnit':             '%', 
    'MaskBlurIcon':             './rope/media/maskblur.png',
    'MaskBlurMessage':          'MASK BLUR - Blurs the edges of the mask. [MW: amount]', 
